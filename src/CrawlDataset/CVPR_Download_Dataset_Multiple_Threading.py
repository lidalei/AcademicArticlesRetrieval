import cookielib, urllib2, json, threading
...
if article_first_ID > article_last_ID:
    ...
    # collect data from network, create Cookie
    ...
    # define thread task, one thread for each article
    ...
    for article_ID in range(article_first_ID, article_last_ID + 1):
        # args = [arg1, arg2] or args = (arg1, arg2)
        thread = threading.Thread(target = crawl_article, args = (article_ID,))
        thread.start()
